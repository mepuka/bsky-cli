...
export class ImagePipeline extends Effect.Service<ImagePipeline>()("@skygent/ImagePipeline", {
  effect: Effect.gen(function* () {
    ...
    return { getCached, ensureCached, ensureCachedMany };
  })
}) {
  static readonly layer = ImagePipeline.Default;
}
